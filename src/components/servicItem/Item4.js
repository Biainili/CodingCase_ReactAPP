...
function Item4() {
  ...
  return (
    <div>
      <h2 className={value === 4 ? styles.textH1 : styles.textH4}>Chat BOT</h2>
      <img
        src={Ph4}
        alt="Img"
        className={value === 4 ? styles.buttonImagePh1 : styles.buttonImagePh4}
      />
      <p className={value === 4 ? styles.text1 : styles.text4}>
